...
class AppManager:
    ...
    def _setup_authentication(self):
        ...
        public_routes = [
            ...
            '/api-keys/generate',  # Temporarily public for API key setup
            '/api-keys/validate',  # Temporarily public for API key validation
            '/external-app/setup'  # Temporarily public for external app setup
        ]
